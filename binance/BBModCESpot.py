...
class BBModCESpot(IStrategy):
    ...
    pSL_1 = DecimalParameter(0.010, 0.020, default=0.016, decimals=3, space='sell', optimize=trailing_optimize)
    pSL_2 = DecimalParameter(0.030, 0.050, default=0.04, decimals=3, space='sell', optimize=trailing_optimize)
